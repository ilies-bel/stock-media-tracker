        ...
        <div className="p-4 sm:p-6 lg:p-8 h-full">
            ...
            LIVE
                ...
                <div className="space-y-4">
                    {/* #1 PhotoPro_USA */}
                    <div
                        className="bg-gradient-to-r from-yellow-50 to-amber-50 border-2 border-yellow-200 rounded-xl p-4 sm:p-6">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div className="flex flex-row items-center justify-between sm:justify-end gap-3 sm:gap-4">
                                <div className="text-left sm:text-right">
                                    ...
                                    <div className="text-xs sm:text-sm text-yellow-700">estimated monthly revenue</div>
                                    <div
                                        className="flex items-center gap-1 text-green-600 font-bold text-xs sm:text-sm">
                                        <TrendingUp className="w-3 sm:w-4 h-3 sm:h-4"/>
                                        +18% growth
                                    </div>
                                </div>
                                <Button variant="outline" size="sm"
                                        className="border-yellow-300 hover:bg-yellow-100 text-xs sm:text-sm px-3 sm:px-4">
                                    More Details
                                </Button>
                            </div>
                        </div>
                    ...
                    {/* #2 CreativeStock */}
                    <div
                        className="bg-gradient-to-r from-gray-50 to-slate-50 border-2 border-gray-200 rounded-xl p-4 sm:p-6">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div>
                            ...
                            <div className="flex flex-row items-center justify-between sm:justify-end gap-3 sm:gap-4">
                                <div className="text-left sm:text-right">
                                    ...
                                    <div className="text-xs sm:text-sm text-gray-700">estimated monthly revenue</div>
                                    <div
                                        className="flex items-center gap-1 text-green-600 font-bold text-xs sm:text-sm">
                                        <TrendingUp className="w-3 sm:w-4 h-3 sm:h-4"/>
                                        +12% growth
                                ...
                                <Button variant="outline" size="sm"
                                        className="border-gray-300 hover:bg-gray-100 text-xs sm:text-sm px-3 sm:px-4">
                                    More Details
                                </Button>
                            </div>
                        </div>
                    ...
                    {/* #3 VisualMaster */}
                    <div
                        className="bg-gradient-to-r from-orange-50 to-amber-50 border-2 border-orange-200 rounded-xl p-4 sm:p-6">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div>
                            ...
                            <div className="flex flex-row items-center justify-between sm:justify-end gap-3 sm:gap-4">
                                <div className="text-left sm:text-right">
                                    ...
                                    <div className="text-xs sm:text-sm text-orange-700">estimated monthly revenue</div>
                                    <div
                                        className="flex items-center gap-1 text-green-600 font-bold text-xs sm:text-sm">
                                        <TrendingUp className="w-3 sm:w-4 h-3 sm:h-4"/>
                                        +25% growth
                                ...
                                <Button variant="outline" size="sm"
                                        className="border-orange-300 hover:bg-orange-100 text-xs sm:text-sm px-3 sm:px-4">
                                    More Details
                                </Button>
                            </div>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-muted/50 rounded-xl p-6">
                        ...
                        <div className="space-y-3">
                            <div
                                className="flex items-start gap-3 p-3 bg-background rounded-lg border-l-4 border-red-500">
                            ...
                            <div
                                className="flex items-start gap-3 p-3 bg-background rounded-lg border-l-4 border-orange-500">
                            ...
                            <div
                                className="flex items-start gap-3 p-3 bg-background rounded-lg border-l-4 border-blue-500">
